...
.. uml::
 ...
 participant "CreateSeparationRuleView" as CV
 participant "AccessService" as AS
 participant "FunctionRepo" as FR
 participant "SeparationRuleRepo" as SR
 participant "SeparationRuleCache" as RC
 participant "AuditLog" as AL

 M -> FE: Define regla con functions
 FE -> CV: POST /api/access/separation-rules/
 ...
 alt Sin permiso
   ...
   CV -> AS: create_separation_rule(payload, invoker)
   ...
   alt Funciones invalidas
     ...
     alt Duplicada
       AS --> CV: SeparationRuleDuplicate
       CV --> FE: 409
     else No duplicada
       group Transaccion atomica
         AS -> SR: insert(payload, invoker)
         AS -> AL: emit SEPARATION_RULE_CREATED
       end
...
.. uml::
 ...
 :INSERT AuditEvent SEPARATION_RULE_X;
 :Commit transaccion;
