...
::
   ...
   contract DutySeparationValidator:
...
::
   ...
   procedure assign_functions(
       ...
       DutySeparationValidator.validate(
         ...
         TransactionManager.atomic(():
           ...
           AuditLog.emit(
             ...
             payload={
               ...
               expires_at: expires_at,
               separation_rules_evaluated_count:
 ...
 * - **All-or-nothing SoD (P-28)**
   - DutySeparationValidator.validate lanza ANTES de la
