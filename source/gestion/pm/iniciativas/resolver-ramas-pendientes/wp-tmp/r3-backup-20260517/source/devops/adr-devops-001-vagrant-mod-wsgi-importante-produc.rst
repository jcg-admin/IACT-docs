...
.. note::
   ...
   La documentacion operativa del despliegue Apache + mod_wsgi en
   produccion vive en :doc:`/infrastructure/overview` y
   :doc:`/infrastructure/conventions`. Este ADR registra la
   decision de usar Vagrant + VirtualBox para el entorno de
   desarrollo local.
