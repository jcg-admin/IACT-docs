...
12.2.1 DutySeparationValidator detecta violacion
------------------------------------------------
...
::
   ...
   WHEN  DutySeparationValidator.validate(set, [rule])
   THEN  raise SoDViolation(
           rule_id=rule.id,
           conflict_pair=(1, 42))

12.2.2 DutySeparationValidator pasa cuando no hay conflict
----------------------------------------------------------
...
::
   ...
   WHEN  DutySeparationValidator.validate
...
::
   ...
   THEN  status == 409 SEPARATION_RULE_VIOLATION
 ...
 * - Capa
   ...
   - CA cubierto
 * - Unit
   - DutySeparationValidator viola / pasa
   - CA-05 / CNST-005
 * - Unit
