...
.. seealso::
   ...
   Relacionado con :doc:`adr-devops-001-vagrant-mod-wsgi-importante-produc`.
   La simulacion de las API de las BD debe considerarse en un
   repositorio separado de Vagrant.
