...
**Documento original:**
``temp-holding/FASE 01/MODELO DOCUMENTAL IACT/MODELO DOCUMENTAL IACT v2.0.x/MODELO DOCUMENTAL IACT v2.0.3/CAPACIDADES_ATOMICAS_VS_PERMISOS_GRANULARES.md``
(no publicado).
