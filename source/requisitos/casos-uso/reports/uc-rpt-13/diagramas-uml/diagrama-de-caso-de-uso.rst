...
.. uml::
 ...
 actor "ReportingService\n(sp_rpt_llamadas_abandonadas)" as ReportingService <<sistema>>
 ...
 UC_RPT_13 --> ReportingService : callproc(period, segments)
 ReportingService --> BdIvrLegacy : CALL sp_rpt_llamadas_abandonadas
