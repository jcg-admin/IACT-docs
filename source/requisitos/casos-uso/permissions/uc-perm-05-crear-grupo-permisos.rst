 ...
 * - **UC Relacionados**
   - UC_PERM_06 (Asignar Funciones a Grupo), UC_PERM_01 (Asignar Grupo a Usuario)
 * - **Clase de Dominio**
   - ``FunctionGroup`` (primaria), ``AuditEvent``
     (per :doc:`/arquitectura-tecnica/modelo-dominio-iact` v1.0.0)
 * - **Funcion RBAC Backing**
   - ACC-006 ``create_function_group`` (per modelo-rbac-iact v5.4.0)
