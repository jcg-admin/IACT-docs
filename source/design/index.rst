...
One such topic is :ref:`partitioning <design-partitioning>`.
It is intimately tied to indexing, which is definitely a task for developers, as we have already discussed.

Another topic is data compression.
The same is of course true of the data stored in PostgreSQL, or any database for that matter.
