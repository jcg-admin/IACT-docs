.. meta::
 :artefacto: AT_UC_OPR_09_DESIGN_COMUNICACION
...
.. _uc_opr_09_design_comunicacion:

=========================================================================
UC_OPR_09 — Ver Propio Historial de Llamadas — Comunicacion entre Objetos
=========================================================================

.. uml::
 :caption: UC_OPR_09 — Ver Propio Historial de Llamadas — Comunicacion entre Objetos

 @startuml

 object ":view_own_call_history" as Actor
