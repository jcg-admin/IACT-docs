.. meta::
 :artefacto: AT_UC_RPT_11_DESIGN_COMUNICACION
...
.. _uc_rpt_11_design_comunicacion:

==========================================================
UC_RPT_11 — Compartir Reporte — Comunicacion entre Objetos
==========================================================

.. uml::
 :caption: UC_RPT_11 — Compartir Reporte — Comunicacion entre Objetos

 @startuml

 object ":share_report" as Actor
