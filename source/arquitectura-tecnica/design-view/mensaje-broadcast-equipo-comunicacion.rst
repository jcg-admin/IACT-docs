.. meta::
 :artefacto: AT_UC_SUP_03_DESIGN_COMUNICACION
...
.. _uc_sup_03_design_comunicacion:

====================================================================
UC_SUP_03 — Mensaje Broadcast al Equipo — Comunicacion entre Objetos
====================================================================

.. uml::
 :caption: UC_SUP_03 — Mensaje Broadcast al Equipo — Comunicacion entre Objetos

 @startuml

 object ":broadcast_team_messages" as Actor
