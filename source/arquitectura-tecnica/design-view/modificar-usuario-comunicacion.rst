.. meta::
 :artefacto: AT_UC_USR_03_DESIGN_COMUNICACION
...
.. _uc_usr_03_design_comunicacion:

==========================================================
UC_USR_03 — Modificar Usuario — Comunicacion entre Objetos
==========================================================

.. uml::
 :caption: UC_USR_03 — Modificar Usuario — Comunicacion entre Objetos

 @startuml

 object ":update_users" as Actor
