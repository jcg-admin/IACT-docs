.. meta::
 :artefacto: AT_UC_ALR_03_DESIGN_COMUNICACION
...
.. _uc_alr_03_design_comunicacion:

=========================================================
UC_ALR_03 — Reconocer Alerta — Comunicacion entre Objetos
=========================================================

.. uml::
 :caption: UC_ALR_03 — Reconocer Alerta — Comunicacion entre Objetos

 @startuml

 object ":acknowledge_alert" as Actor
