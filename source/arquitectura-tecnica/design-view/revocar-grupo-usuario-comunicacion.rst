.. meta::
 :artefacto: AT_UC_PERM_02_DESIGN_COMUNICACION
...
.. _uc_perm_02_design_comunicacion:

=================================================================
UC_PERM_02 — Revocar Grupo a Usuario — Comunicacion entre Objetos
=================================================================

.. uml::
 :caption: UC_PERM_02 — Revocar Grupo a Usuario — Comunicacion entre Objetos

 @startuml

 object ":revoke_function_group" as Actor
