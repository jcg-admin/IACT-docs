.. meta::
 :artefacto: AT_UC_LOG_05_DESIGN_COMUNICACION
...
.. _uc_log_05_design_comunicacion:

====================================================================
UC_LOG_05 — Ver Logs de Infraestructura — Comunicacion entre Objetos
====================================================================

.. uml::
 :caption: UC_LOG_05 — Ver Logs de Infraestructura — Comunicacion entre Objetos

 @startuml

 object ":view_infrastructure_logs" as Actor
