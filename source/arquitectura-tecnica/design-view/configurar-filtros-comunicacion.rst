.. meta::
 :artefacto: AT_UC_RPT_09_DESIGN_COMUNICACION
...
.. _uc_rpt_09_design_comunicacion:

===========================================================
UC_RPT_09 — Configurar Filtros — Comunicacion entre Objetos
===========================================================

.. uml::
 :caption: UC_RPT_09 — Configurar Filtros — Comunicacion entre Objetos

 @startuml

 object ":filter_reports" as Actor
