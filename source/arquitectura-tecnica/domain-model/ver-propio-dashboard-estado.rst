.. meta::
 :artefacto: AT_UC_OPR_08_DOMAIN_ESTADO
...
.. _uc_opr_08_domain_estado:

===========================================================
UC_OPR_08 — Ver Propio Dashboard — Estado de AccionOperador
===========================================================

.. uml::
 :caption: UC_OPR_08 — Ver Propio Dashboard — Estado de AccionOperador
