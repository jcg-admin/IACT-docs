.. meta::
 :artefacto: AT_UC_RPT_12_DOMAIN_ESTADO
...
.. _uc_rpt_12_domain_estado:

==================================================
UC_RPT_12 — Reporte de Agentes — Estado de Reporte
==================================================

.. uml::
 :caption: UC_RPT_12 — Reporte de Agentes — Estado de Reporte
