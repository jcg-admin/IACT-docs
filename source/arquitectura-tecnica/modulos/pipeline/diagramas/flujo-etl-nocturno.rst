...
.. uml::
 ...
 sp_etl_maestro -> pipeline_runs : registrar pipeline_runs (estado=en_ejecucion)
 ...
 sp_etl_maestro -> pipeline_runs : actualizar pipeline_runs SET estado=exitoso

 note over Supervisionetlendpoint
   view_pipeline_status consulta pipeline_runs.
