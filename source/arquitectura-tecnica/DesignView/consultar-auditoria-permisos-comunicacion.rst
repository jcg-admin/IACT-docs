.. meta::
 :artefacto: AT_UC_PERM_10_DESIGN_COMUNICACION
...
.. _uc_perm_10_design_comunicacion:

=========================================================================
UC_PERM_10 — Consultar Auditoria de Permisos — Comunicacion entre Objetos
=========================================================================

.. uml::
 :caption: UC_PERM_10 — Consultar Auditoria de Permisos — Comunicacion entre Objetos
