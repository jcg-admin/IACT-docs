.. meta::
 :artefacto: AT_UC_LOG_01_DESIGN_COMUNICACION
...
.. _uc_log_01_design_comunicacion:

===================================================================
UC_LOG_01 — Consultar Logs del Sistema — Comunicacion entre Objetos
===================================================================

.. uml::
 :caption: UC_LOG_01 — Consultar Logs del Sistema — Comunicacion entre Objetos

 @startuml

 object ":view_application_logs" as Actor
