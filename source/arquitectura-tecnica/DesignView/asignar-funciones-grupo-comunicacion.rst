.. meta::
 :artefacto: AT_UC_PERM_06_DESIGN_COMUNICACION
...
.. _uc_perm_06_design_comunicacion:

===================================================================
UC_PERM_06 — Asignar Funciones a Grupo — Comunicacion entre Objetos
===================================================================

.. uml::
 :caption: UC_PERM_06 — Asignar Funciones a Grupo — Comunicacion entre Objetos

 @startuml

 object ":assign_functions_to_group" as Actor
