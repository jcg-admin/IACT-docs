.. meta::
 :artefacto: AT_UC_ACC_01_DESIGN_COMUNICACION
...
.. _uc_acc_01_design_comunicacion:

==========================================================
UC_ACC_01 — Asignar Funciones — Comunicacion entre Objetos
==========================================================

.. uml::
 :caption: UC_ACC_01 — Asignar Funciones — Comunicacion entre Objetos

 @startuml

 object ":assign_functions" as Actor
