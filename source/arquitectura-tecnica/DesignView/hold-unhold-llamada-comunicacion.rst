.. meta::
 :artefacto: AT_UC_OPR_04_DESIGN_COMUNICACION
...
.. _uc_opr_04_design_comunicacion:

============================================================
UC_OPR_04 — Hold Unhold Llamada — Comunicacion entre Objetos
============================================================

.. uml::
 :caption: UC_OPR_04 — Hold Unhold Llamada — Comunicacion entre Objetos

 @startuml

 object ":hold_calls" as Actor
