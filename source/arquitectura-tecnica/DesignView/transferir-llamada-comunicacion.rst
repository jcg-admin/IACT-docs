.. meta::
 :artefacto: AT_UC_OPR_05_DESIGN_COMUNICACION
...
.. _uc_opr_05_design_comunicacion:

===========================================================
UC_OPR_05 — Transferir Llamada — Comunicacion entre Objetos
===========================================================

.. uml::
 :caption: UC_OPR_05 — Transferir Llamada — Comunicacion entre Objetos

 @startuml

 object ":transfer_calls" as Actor
