.. meta::
 :artefacto: AT_UC_LOG_03_DESIGN_COMUNICACION
...
.. _uc_log_03_design_comunicacion:

====================================================
UC_LOG_03 — Buscar Logs — Comunicacion entre Objetos
====================================================

.. uml::
 :caption: UC_LOG_03 — Buscar Logs — Comunicacion entre Objetos

 @startuml

 object ":search_logs" as Actor
