.. meta::
 :artefacto: AT_UC_RPT_02_DESIGN_COMUNICACION
...
.. _uc_rpt_02_design_comunicacion:

====================================================================
UC_RPT_02 — Ver Metricas en Tiempo Real — Comunicacion entre Objetos
====================================================================

.. uml::
 :caption: UC_RPT_02 — Ver Metricas en Tiempo Real — Comunicacion entre Objetos

 @startuml

 object ":view_kpis" as Actor
