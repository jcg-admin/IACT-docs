.. meta::
 :artefacto: AT_UC_AUTH_02_DESIGN_COMUNICACION
...
.. _uc_auth_02_design_comunicacion:

=======================================================
UC_AUTH_02 — Cerrar Sesion — Comunicacion entre Objetos
=======================================================

.. uml::
 :caption: UC_AUTH_02 — Cerrar Sesion — Comunicacion entre Objetos

 @startuml

 object ":close_user_session" as Actor
