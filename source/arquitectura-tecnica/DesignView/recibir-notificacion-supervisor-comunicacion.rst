.. meta::
 :artefacto: AT_UC_OPR_10_DESIGN_COMUNICACION
...
.. _uc_opr_10_design_comunicacion:

========================================================================
UC_OPR_10 — Recibir Notificacion Supervisor — Comunicacion entre Objetos
========================================================================

.. uml::
 :caption: UC_OPR_10 — Recibir Notificacion Supervisor — Comunicacion entre Objetos

 @startuml

 object ":read_own_mailbox" as Actor
