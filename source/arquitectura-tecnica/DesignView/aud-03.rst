...
====================================================
UC_AUD_03 — Exportar Auditoria: Design View
====================================================

Secuencia del flujo principal. Muestra como el sistema resuelve
UC_AUD_03 tecnicamente.
...
.. uml::
 ...
 Iface --> export_audit_log : renderizar vista
 deactivate Iface
...
.. uml::
 :caption: UC_AUD_03 — Exportar Auditoria — Comunicacion entre Objetos

 @startuml

 object ":export_audit_log" as Actor
...
.. seealso::
 ...
 :doc:`/requisitos/casos-uso/audit/uc-aud-03/diagramas-uml`
