.. meta::
 :artefacto: AT_UC_RPT_04_DESIGN_COMUNICACION
...
.. _uc_rpt_04_design_comunicacion:

=========================================================
UC_RPT_04 — Exportar Reporte — Comunicacion entre Objetos
=========================================================

.. uml::
 :caption: UC_RPT_04 — Exportar Reporte — Comunicacion entre Objetos

 @startuml

 object ":export_csv" as Actor
