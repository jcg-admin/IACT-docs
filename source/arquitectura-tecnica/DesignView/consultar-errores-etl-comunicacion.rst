.. meta::
 :artefacto: AT_UC_PIP_02_DESIGN_COMUNICACION
...
.. _uc_pip_02_design_comunicacion:

==============================================================
UC_PIP_02 — Consultar Errores ETL — Comunicacion entre Objetos
==============================================================

.. uml::
 :caption: UC_PIP_02 — Consultar Errores ETL — Comunicacion entre Objetos

 @startuml

 object ":view_pipeline_errors" as Actor
