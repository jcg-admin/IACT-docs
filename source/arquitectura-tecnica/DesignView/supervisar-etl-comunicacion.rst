.. meta::
 :artefacto: AT_UC_PIP_01_DESIGN_COMUNICACION
...
.. _uc_pip_01_design_comunicacion:

=======================================================
UC_PIP_01 — Supervisar ETL — Comunicacion entre Objetos
=======================================================

.. uml::
 :caption: UC_PIP_01 — Supervisar ETL — Comunicacion entre Objetos

 @startuml

 object ":view_pipeline_status" as Actor
