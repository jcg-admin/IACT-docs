.. meta::
 :artefacto: AT_UC_LOG_05_DOMAIN_ESTADO
...
.. _uc_log_05_domain_estado:

==============================================================
UC_LOG_05 — Ver Logs de Infraestructura — Estado de EntradaLog
==============================================================

.. uml::
 :caption: UC_LOG_05 — Ver Logs de Infraestructura — Estado de EntradaLog
