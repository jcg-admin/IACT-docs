.. meta::
 :artefacto: AT_UC_RPT_04_DOMAIN_ESTADO
...
.. _uc_rpt_04_domain_estado:

================================================
UC_RPT_04 — Exportar Reporte — Estado de Reporte
================================================

.. uml::
 :caption: UC_RPT_04 — Exportar Reporte — Estado de Reporte
