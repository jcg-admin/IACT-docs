.. meta::
 :artefacto: AT_UC_AUTH_02_DOMAIN_ESTADO
...
.. _uc_auth_02_domain_estado:

==============================================
UC_AUTH_02 — Cerrar Sesion — Estado de Session
==============================================

.. uml::
 :caption: UC_AUTH_02 — Cerrar Sesion — Estado de Session
