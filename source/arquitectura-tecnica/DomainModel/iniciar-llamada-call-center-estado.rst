.. meta::
 :artefacto: AT_UC_CLI_01_DOMAIN_ESTADO
...
.. _uc_cli_01_domain_estado:

====================================================================
UC_CLI_01 — Iniciar Llamada al Call Center — Estado de SesionLlamada
====================================================================

.. uml::
 :caption: UC_CLI_01 — Iniciar Llamada al Call Center — Estado de SesionLlamada
