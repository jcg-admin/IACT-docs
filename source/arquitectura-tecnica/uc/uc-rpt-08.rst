...
Entidades del dominio y sus relaciones para UC_RPT_08.
...
Secuencia del flujo principal de UC_RPT_08.

.. uml::
 :caption: UC_RPT_08 — Design View (secuencia)
...
Componentes de codigo que implementan UC_RPT_08.

.. uml::
 :caption: UC_RPT_08 — Implementation View
...
Flujo de actividades y concurrencia de UC_RPT_08.

.. uml::
 :caption: UC_RPT_08 — Process View (actividades)

 @startuml

 start
 :view_reports solicita Ver Reportes Programados;
...
Distribucion fisica de componentes para UC_RPT_08.
