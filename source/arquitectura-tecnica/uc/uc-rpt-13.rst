...
Entidades del dominio y sus relaciones para UC_RPT_13.
...
Secuencia del flujo principal de UC_RPT_13.
...
Componentes de codigo que implementan UC_RPT_13.

.. uml::
 :caption: UC_RPT_13 — Implementation View
...
Flujo de actividades y concurrencia de UC_RPT_13.

.. uml::
 :caption: UC_RPT_13 — Process View (actividades)

 @startuml

 start
 :view_reports solicita Reporte de Colas;
...
Distribucion fisica de componentes para UC_RPT_13.
