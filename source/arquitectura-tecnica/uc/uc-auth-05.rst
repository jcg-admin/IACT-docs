...
Entidades del dominio y sus relaciones para UC_AUTH_05.
...
Secuencia del flujo principal de UC_AUTH_05.
...
Componentes de codigo que implementan UC_AUTH_05.
...
Flujo de actividades y concurrencia de UC_AUTH_05.

.. uml::
 :caption: UC_AUTH_05 — Process View (actividades)

 @startuml

 start
 :view_own_sessions solicita Gestionar Sesiones;
...
Distribucion fisica de componentes para UC_AUTH_05.
