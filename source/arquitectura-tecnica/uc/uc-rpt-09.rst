...
Entidades del dominio y sus relaciones para UC_RPT_09.
...
Secuencia del flujo principal de UC_RPT_09.
...
.. uml::
 ...
 filter_reports -> Frontend : solicitar
 activate Frontend
 ...
 Frontend --> filter_reports : renderizar vista
 deactivate Frontend
...
Componentes de codigo que implementan UC_RPT_09.

.. uml::
 :caption: UC_RPT_09 — Implementation View
...
Flujo de actividades y concurrencia de UC_RPT_09.
...
Distribucion fisica de componentes para UC_RPT_09.

.. uml::
 :caption: UC_RPT_09 — Deployment View
