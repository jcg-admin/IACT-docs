...
Entidades del dominio y sus relaciones para UC_INC_RPT_01.
...
.. _uc_inc_rpt_01_design:

2. Design View — Vista de Diseno
==================================

Secuencia del flujo principal de UC_INC_RPT_01.

.. uml::
 :caption: UC_INC_RPT_01 — Design View (secuencia)
...
Componentes de codigo que implementan UC_INC_RPT_01.
...
Flujo de actividades y concurrencia de UC_INC_RPT_01.
...
Distribucion fisica de componentes para UC_INC_RPT_01.
