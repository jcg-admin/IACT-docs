...
Entidades del dominio y sus relaciones para UC_OPR_03.
...
Secuencia del flujo principal de UC_OPR_03.
...
Componentes de codigo que implementan UC_OPR_03.

.. uml::
 :caption: UC_OPR_03 — Implementation View
...
Flujo de actividades y concurrencia de UC_OPR_03.

.. uml::
 :caption: UC_OPR_03 — Process View (actividades)

 @startuml

 start
 :make_outbound_calls solicita Realizar Llamada Saliente;
...
Distribucion fisica de componentes para UC_OPR_03.
