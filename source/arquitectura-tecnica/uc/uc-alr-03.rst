...
Entidades del dominio y sus relaciones para UC_ALR_03.
...
Secuencia del flujo principal de UC_ALR_03.
...
Componentes de codigo que implementan UC_ALR_03.
...
Actores RBAC, relaciones y confines del MOD_Alerts.
...
Flujo de actividades y concurrencia de UC_ALR_03.

.. uml::
 :caption: UC_ALR_03 — Process View (actividades)

 @startuml

 start
 :acknowledge_alert solicita Reconocer Alerta;
...
Distribucion fisica de componentes para UC_ALR_03.
