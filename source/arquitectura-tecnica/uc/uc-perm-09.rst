...
Entidades del dominio y sus relaciones para UC_PERM_09.
...
Secuencia del flujo principal de UC_PERM_09.
...
Componentes de codigo que implementan UC_PERM_09.

.. uml::
 :caption: UC_PERM_09 — Implementation View
...
.. uml::
 ...
 rectangle "MOD_Permissions" {
   usecase "UC_PERM_09\nAuditar Acceso (write side)" as UCPERM09
 }
...
Flujo de actividades y concurrencia de UC_PERM_09.
...
.. uml::
 ...
 start
 :view_audit_log solicita Auditar Acceso (write side);
...
Distribucion fisica de componentes para UC_PERM_09.
