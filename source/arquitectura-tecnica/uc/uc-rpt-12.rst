...
Entidades del dominio y sus relaciones para UC_RPT_12.
...
Secuencia del flujo principal de UC_RPT_12.

.. uml::
 :caption: UC_RPT_12 — Design View (secuencia)
...
Componentes de codigo que implementan UC_RPT_12.
...
.. uml::
 :caption: UC_RPT_12 — Use Case View
 ...
 rectangle "MOD_Reports" {
   usecase "UC_RPT_12\nReporte de Agentes" as UCRPT12
 }

 view_reports --> UCRPT12
...
Flujo de actividades y concurrencia de UC_RPT_12.
...
Distribucion fisica de componentes para UC_RPT_12.

.. uml::
 :caption: UC_RPT_12 — Deployment View
