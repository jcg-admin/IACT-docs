...
Entidades del dominio y sus relaciones para UC_RPT_01.
...
Secuencia del flujo principal de UC_RPT_01.
...
Componentes de codigo que implementan UC_RPT_01.

.. uml::
 :caption: UC_RPT_01 — Implementation View
...
Flujo de actividades y concurrencia de UC_RPT_01.

.. uml::
 :caption: UC_RPT_01 — Process View (actividades)

 @startuml

 start
 :view_dashboard solicita Ver Dashboard;
...
Distribucion fisica de componentes para UC_RPT_01.
