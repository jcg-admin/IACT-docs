...
Entidades del dominio y sus relaciones para UC_RPT_07.
...
Secuencia del flujo principal de UC_RPT_07.
...
Componentes de codigo que implementan UC_RPT_07.

.. uml::
 :caption: UC_RPT_07 — Implementation View
...
Flujo de actividades y concurrencia de UC_RPT_07.

.. uml::
 :caption: UC_RPT_07 — Process View (actividades)

 @startuml

 start
 :schedule_report solicita Programar Reporte;
...
Distribucion fisica de componentes para UC_RPT_07.
