.. _modelo-rbac-iact-modelo-datos:

===================================
Modelo RBAC IACT — Modelo de Datos
===================================
...
1. **``functions``** - 64 funciones atómicas activas (v5.6.0; catálogo declara 77 — OPR+SUP reservadas open-closed)
