...
Sistema web multi-tier compuesto por:
...
Pipeline ETL: el sistema extrae datos desde MySQL, los normaliza
y los carga en PostgreSQL para servir consultas analíticas.
