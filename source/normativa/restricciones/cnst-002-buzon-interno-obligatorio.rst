...
alineado con :doc:`cnst-001-prohibicion-de-email-y-smtp`. Previene
 ...
 * - **CNSTs relacionadas**
   - :doc:`cnst-001-prohibicion-de-email-y-smtp`, :doc:`cnst-008-sincronizacion-etl-en-ventana-de-6-a-12-horas`
 * - **BR derivadas**
   - BR (pendiente)
 * - **UCs afectados**
