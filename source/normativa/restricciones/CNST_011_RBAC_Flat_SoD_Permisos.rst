...
CNST-011: Modelo RBAC Flat + SoD + Permisos Temporales
======================================================
...
hasta ahora estaba distribuida entre BR-006 (regla de negocio pendiente de WP requisitos) (regla de negocio),
...
.. list-table::
   ...
   * - **Reglas de negocio derivadas**
     - BR-006 (regla de negocio pendiente de WP requisitos)
