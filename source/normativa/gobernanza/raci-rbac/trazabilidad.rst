.. _raci-rbac-iact-trazabilidad:

===========================================
RACI RBAC IACT — Trazabilidad
===========================================
...
- :doc:`/arquitectura-tecnica/rbac/modelo-rbac-iact/index` — modelo
  conceptual v5.6.0 (catalogo de 77 funciones declaradas (64 activas + 13 reservadas open-closed) + 12 AGR + 3 separation rules).
...
- :doc:`/normativa/restricciones/cnst-030-reglas-de-separacion-de-funciones` —
  3 reglas de separacion declarativas.
