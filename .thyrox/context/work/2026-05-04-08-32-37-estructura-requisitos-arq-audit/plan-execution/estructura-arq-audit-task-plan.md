...
- [ ] [T-007] Verificar build: `make html` debe dar 0 WARNING/ERROR relacionados
...
- [ ] [T-014] Crear `deploy-view/deploy-estandar.rst` — diagrama canónico tipo
  `Client → WebServer(App) → DB` (variante de los 71 idénticos).
  Metadata correcta, alias STD-011, caption descriptivo.
  `Dependencias: ninguna`

- [ ] [T-015] Crear `deploy-view/deploy-auth-cache.rst` — diagrama con nodo cache
  (variante de los 5 de auth/sesiones).
  `Dependencias: ninguna`

- [ ] [T-016] Crear `deploy-view/deploy-etl.rst` — diagrama con disparador ETL y SP call
  (variante de los 4 ETL).
  `Dependencias: ninguna`

- [ ] [T-017] Actualizar `deploy-view/index.rst`: toctree con 3 canónicos + descripción
...
- [ ] [T-018] Eliminar los 80 archivos per-UC de `deploy-view/`. Verificar 0 referencias
  cruzadas externas antes de eliminar.
  `Dependencias: T-017`

- [ ] [T-019] Verificar build: 0 warnings relacionados con `deploy-view/`.
  `Dependencias: T-018`
...
- [ ] [T-020] Para cada uno de los 12 módulos crear `design-view/mod-{nombre}.rst`
...
- [ ] [T-021] Actualizar `design-view/index.rst`: toctree con 12 canónicos,
  descripción del Design View (patrones de interacción por módulo).
  `Dependencias: T-020`

- [ ] [T-022] Eliminar los 160 archivos per-UC de `design-view/`
  (`{uc}-secuencia.rst` y `{uc}-comunicacion.rst`). Verificar 0 refs externas.
  `Dependencias: T-021`

- [ ] [T-023] Verificar build: 0 warnings relacionados con `design-view/`.
  `Dependencias: T-022`
...
- [ ] [T-024] Para cada uno de los 12 módulos extraer el diagrama único real
...
- [ ] [T-025] Actualizar `implementation-view/index.rst`: toctree con 12 canónicos.
  `Dependencias: T-024`

- [ ] [T-026] Eliminar los 80 archivos per-UC de `implementation-view/`.
  Verificar 0 refs externas antes de borrar.
  `Dependencias: T-025`

- [ ] [T-027] Verificar build: 0 warnings relacionados con `implementation-view/`.
  `Dependencias: T-026`
...
- [ ] [T-028] Crear `process-view/proc-etl-pipeline.rst` — diagrama de actividad/secuencia
...
- [ ] [T-034] Mover los archivos per-UC de `process-view/` sin equivalente en UC specs
  a `requisitos/casos-uso/{dominio}/{uc}/diagramas-uml/diagrama-actividad.rst`.
  `Dependencias: T-033`

- [ ] [T-035] Eliminar los archivos per-UC de `process-view/` que ya tienen equivalente
  en UC specs (duplicados). Eliminar los que se migraron en T-034.
  `Dependencias: T-032, T-034`

- [ ] [T-036] Verificar build: 0 warnings relacionados con `process-view/`.
  `Dependencias: T-035`
...
- [ ] [T-037] Crear `source/requisitos/reglas-negocio/rbac/` (si no existe).
...
- [ ] [T-038] Mover `arquitectura-tecnica/rbac/raci-rbac-iact/` completo a
  `source/normativa/gobernanza/raci-rbac/`. Actualizar referencias en
  `normativa/gobernanza/index.rst`.
  `Dependencias: ninguna`

- [ ] [T-039] Buscar y actualizar las 38 referencias cruzadas (`:doc:`) que apuntan
  a los archivos movidos en T-037 y T-038. Usar grep para encontrarlas todas.
  `Dependencias: T-037, T-038`

- [ ] [T-040] Actualizar `arquitectura-tecnica/rbac/modelo-rbac-iact/index.rst` para
...
- [ ] [T-041] Verificar build: 0 warnings relacionados con `rbac/`.
...
- [ ] [T-042] Verificar que la información de los 8 `casos-uso.rst` en
...
- [ ] [T-043] Actualizar los `modulos/*/index.rst` para eliminar la referencia a
  `casos-uso.rst` de cada módulo (si estaban en toctree).
  `Dependencias: T-042`

- [ ] [T-044] Eliminar los 8 `casos-uso.rst` redundantes de `modulos/`.
  `Dependencias: T-043`

- [ ] [T-045] Verificar build: 0 warnings post-eliminación.
  `Dependencias: T-044`
...
- [ ] [T-046] Ejecutar `bash .claude/scripts/validate-phase-completion.sh`.
  Verificar: working tree clean, remote sync, build 0/0/0.
  `Dependencias: T-007, T-013, T-019, T-023, T-027, T-036, T-041, T-045`

- [ ] [T-047] Actualizar `now.md`: stage → `track`, phase → `Phase 11 — TRACK/EVALUATE`.
  `Dependencias: T-046`

- [ ] [T-048] Crear `track/estructura-arq-audit-changelog.md` con resumen de cambios:
