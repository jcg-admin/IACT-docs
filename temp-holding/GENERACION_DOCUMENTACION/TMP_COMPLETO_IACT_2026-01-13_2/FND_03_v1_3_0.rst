...
.. code-block:: text
   ...
   REPORTES BASE:
   UC-017: Generar Reporte Predefinido
   UC-018: Crear Reporte Personalizado
   UC-019: Programar Reporte Automatico
   ...
   DASHBOARDS:
   UC-025: Visualizar Dashboard Operativo
   UC-026: Ver KPIs en Tiempo Real
   UC-027: Analizar Tendencias
   UC-028: Comparar Periodos
   UC-029: Filtrar Dashboard por Centro
   UC-030: Exportar Vista Dashboard
...
.. code-block:: text
   ...
   UC-038: Consultar Historial de Alertas
   UC-039: Modificar Configuracion de Alerta
...
.. list-table::
   ...
   * - 1.3.0
     - 2026-01-06
     - Equipo IACT
     - Nombres de UC actualizados para coincidir con documentacion generada. MOD_Access: UC-011 y UC-042 renombrados. MOD_Reports: UC-017 a UC-019, UC-025 a UC-030 renombrados a nombres mas genericos. MOD_Alerts: UC-038 y UC-039 corregidos. MOD_Pipeline: UC-053 renombrado.
   * - 1.2.0
     - 2026-01-04
     - Equipo IACT
