...
**padre** del trabajo en curso (refactor masivo de
documentación IACT — UCs, RBAC, domain-model, vistas
arquitectónicas, etc.). Múltiples sub-features la
componen:

- `feature/cnst-033-uml-conformance`
- `feature/arquitectura-tecnica-content`
- `feature/repository-diagnostics` (mergeada)
- `feature/project-setup` (mergeada)
...
| Tipo | Patrón | Ejemplo |
|------|--------|---------|
| Sub-feature por WP | `feature/<wp-slug>` | `feature/cnst-033-uml-conformance` |
